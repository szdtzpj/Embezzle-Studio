...
The current stable Latest remains [`v1.6.0`](https://github.com/szdtzpj/Embezzle-Studio/releases/tag/v1.6.0) / Android versionCode 12. `1.7.0` / code 13 is release source under validation and must not be represented as a public APK until the protected workflow completes. Formal publication will be based on the Actions artifact, immutable Release, and verified Pages download chain.
