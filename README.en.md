...
The current stable Latest is [`v1.6.0`](https://github.com/szdtzpj/Embezzle-Studio/releases/tag/v1.6.0) / Android versionCode 12. It was published by `szdtzpj`, is immutable, non-draft, and non-prerelease, and contains exactly 3 formal assets uploaded by `github-actions[bot]`. The pre-publication local candidate remains historical acceptance evidence and must be distinguished from the Actions-built formal APK.
