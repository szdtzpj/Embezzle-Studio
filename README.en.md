...
The current stable Latest is [`v1.5.0`](https://github.com/szdtzpj/Embezzle-Studio/releases/tag/v1.5.0) / Android versionCode 11. It is immutable, non-prerelease, and contains exactly 3 formal assets. The existing local `1.2.0`, `1.3.0`, `1.4.0`, and `1.5.0` candidates remain historical evidence for their respective development stages and must be distinguished from the Actions-built formal APKs.
