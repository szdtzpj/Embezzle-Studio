...
describe('checkForAppUpdate', () => {
  ...
  it.each([
    ['non-APK', { name: 'ios.ipa', downloadUrl: 'https://github.com/szdtzpj/Embezzle-Studio/releases/download/v1.0.5/ios.ipa', sha256: 'a'.repeat(64) }],
    ['HTTP URL', { name: 'app.apk', downloadUrl: 'http://github.com/szdtzpj/Embezzle-Studio/releases/download/v1.0.5/app.apk', sha256: 'a'.repeat(64) }],
    ...
    ['missing checksum', { name: 'app.apk', downloadUrl: 'https://github.com/szdtzpj/Embezzle-Studio/releases/download/v1.0.5/app.apk' }],
