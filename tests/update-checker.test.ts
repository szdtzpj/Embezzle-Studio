...
describe('checkForAppUpdate', () => {
  it('accepts only a checksum-backed APK asset from this repository', async () => {
    vi.stubGlobal('fetch', vi.fn().mockResolvedValue(new Response(JSON.stringify({
      ...
      version: '1.6.1',
      releaseName: 'Stable',
      releaseUrl: 'https://github.com/szdtzpj/Embezzle-Studio/releases/tag/v1.6.1',
      apk: {
        name: 'Embezzle-Studio.apk',
        downloadUrl: 'https://github.com/szdtzpj/Embezzle-Studio/releases/download/v1.6.1/Embezzle-Studio.apk',
        sha256: 'A'.repeat(64),
      },
    ...
    expect(update.releaseUrl).toBe('https://github.com/szdtzpj/Embezzle-Studio/releases/tag/v1.6.1');
  });
  ...
  it('accepts the pinned public GitHub Pages download path used for private releases', async () => {
    vi.stubGlobal('fetch', vi.fn().mockResolvedValue(new Response(JSON.stringify({
      ...
      apk: {
        name: 'Embezzle-Studio-v1.6.1-release.apk',
        downloadUrl: 'https://szdtzpj.github.io/Embezzle-Studio/downloads/Embezzle-Studio-v1.6.1-release.apk',
        sha256: 'b'.repeat(64),
      },
    }), { status: 200 })));
  ...
  it.each([
    ['non-APK', { name: 'ios.ipa', downloadUrl: 'https://github.com/szdtzpj/Embezzle-Studio/releases/download/v1.6.1/ios.ipa', sha256: 'a'.repeat(64) }],
    ['HTTP URL', { name: 'app.apk', downloadUrl: 'http://github.com/szdtzpj/Embezzle-Studio/releases/download/v1.6.1/app.apk', sha256: 'a'.repeat(64) }],
    ...
    ['missing checksum', { name: 'app.apk', downloadUrl: 'https://github.com/szdtzpj/Embezzle-Studio/releases/download/v1.6.1/app.apk' }],
