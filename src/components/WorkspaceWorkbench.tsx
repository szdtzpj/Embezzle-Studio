...
function createStyles(theme: KelivoTheme) {
  ...
  dangerButton: { flex: 1, minHeight: 44, borderRadius: 13, backgroundColor: colors.dangerBackground, alignItems: 'center', justifyContent: 'center', flexDirection: 'row', gap: 7 },
  ...
  diffAdded: { color: colors.diffAdded, fontSize: 12, fontWeight: '700' },
  diffRemoved: { color: colors.diffRemoved, fontSize: 12, fontWeight: '700' },
  diffAddedLine: { color: colors.diffAddedLine, fontSize: 11, lineHeight: 16, fontFamily: 'monospace' },
  diffRemovedLine: { color: colors.diffRemovedLine, fontSize: 11, lineHeight: 16, fontFamily: 'monospace' },
...
function themeColors(theme: KelivoTheme) {
  return {
    ...
    diffAdded: theme.dark ? '#6DD58C' : '#15803D',
    diffRemoved: theme.dark ? '#FFB1C2' : '#B91C1C',
    diffAddedLine: theme.dark ? '#A7E8B7' : '#166534',
    diffRemovedLine: theme.dark ? '#FFD9E1' : '#991B1B',
