...
- `npm.cmd run check` passes 76 test files / 1,014 tests with clean TypeScript and ESLint. Web export passes at 3,483 modules with an approximately 8.2 MB main bundle. `npx.cmd expo install --check` passes and Expo Doctor is 20/20.
