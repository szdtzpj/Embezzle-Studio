...
## Current `1.2.0` checkpoint evidence (2026-07-11)

- The development target is `1.2.0` / Android versionCode 8. It is not tagged, uploaded, or published; public stable remains `v1.0.6`.
